...
public final class OwmStrings {
    ...
    public static final String OWM_COORD_LON = "lon";
    ...
    public static final String OWM_TEMPERATURE_MAX = "max";
    public static final String OWM_TEMPERATURE_MIN = "min";
    ...
    public static final String OWM_WEATHER_SHORT_DESC = "main";
    public static final String OWM_WEATHER_ID = "id";
    public static final String OWM_WIND_SPEED = "speed";
    public static final String OWM_WIND_DEG = "deg";
}
