    ...
    for (int i = 0; i < 2; i++) {
      ...
      if (locationCursor.moveToFirst()) {
        assertEquals("Error: the queried value of locationId does "
                + "not match the returned value from addLocation",
      ...
      assertFalse("Error: there should be only one record returned from a "
              + "location query",
      ...
      assertEquals("Error: inserting a location again should return the same "
              + "ID",
